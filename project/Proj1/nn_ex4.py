...
def mlp_classifier(X_train, y_train, X_test, y_test):
    ...
    parameter_space = {
        'hidden_layer_sizes': [(1,), (1,1), (2,), (2,1), (2,2), (3,), (3,1), (3,2), (3,3), (4,), (4,1), (4,2), (4,3), (4,4)],
    ...
    # Run the search
    clf = GridSearchCV(clf, parameter_space, n_jobs=-1, cv=10)
...
def neural_network_balanced():
    ...
    cols = [col for col in df.columns if col not in ['Falha']]
    ...
    naiveBayes_acc = naive_bayes(data_train, target_train, data_val, target_val)

    # Run MLPC
    classifier_acc = mlp_classifier(data_train, target_train, data_test, target_test)

    # Compare GaussianNB and Classifier accuracy
    print("Gaussian Naive-Bayes accuracy:", naiveBayes_acc)
...
def neural_network_past():
    ...
    new_train = duplicate_crash(train, 10)
    ...
    # Run Gaussian Naive-Bayes Model
    naive_bayes_acc = naive_bayes(data_train, target_train, data_val, target_val)

    # Run MLPC
    classifier_acc = mlp_classifier(data_train, target_train, data_test, target_test)

    # Compare GaussianNB and Classifier accuracy
    print("Gaussian Naive-Bayes accuracy:", naive_bayes_acc)
    print("MLP Classifier accuracy:", classifier_acc)
